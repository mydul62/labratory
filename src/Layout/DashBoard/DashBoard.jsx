...
const handleDashboard =()=>{
  ...
  return (
  <div>
  <div className="lg:hidden flex  justify-end  mr-8 py-4 border-b border-dashed mb-2">
  <FaBars onClick={ handleDashboard} ></FaBars>
  </div>
  <aside className="flex">
  
    <div className={` z-50 flex flex-col lg:translate-x-0 ${dashboard?'translate-x-[-100%]':'translate-x-0' } duration-500 absolute lg:static w-80 xs:w-[70%] h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700`}>
    <div className="flex">
     <div className="md:flex flex-col items-center w-16 h-screen py-8 bg-white dark:bg-gray-900 dark:border-gray-700">
      ...
      <div className="h-screen px-5 py-8 overflow-y-auto bg-white border-l border-r sm:w-64 w-60 dark:bg-gray-900 dark:border-gray-700">
          ...
          <nav className="mt-4 -mx-3 space-y-6 ">
              ...
              <div className="space-y-3 ">
                  ...
                  <NavLink to={'dashboard/alltest'} className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5">
