      ...
      <div className="max-w-7xl px-6 py-3 mx-auto border-b-2 border-dashed border-[#c1bfbf]">
        <div className="lg:flex lg:items-center lg:justify-between">
          ...
          <div
            ...
            } fixed inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent  lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center`}
          >
