...
const pathform = location?.state || "/Dashboard";
    ...
    return (
        <div className="flex w-full max-w-sm mx-auto overflow-hidden my-12 bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
            ...
            <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <Link to={'/registration'} href="#" className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or sign up</Link>
